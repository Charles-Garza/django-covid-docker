...
urlpatterns = [
    ...
    path('state/<str:fk>/counties', views.every_state_county_case, name='api-every-county-cases'),
    path('state/<str:fk>/county/<str:pk>', views.state_county_cases, name='api-state-county-cases'),
    path('counties/all', views.all_county_cases, name='api-all-state-county-cases'),
]